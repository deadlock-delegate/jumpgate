...
from jumpcrypto.configuration.network import get_network
from jumpcrypto.constants import TRANSACTION_TYPES
from jumpcrypto.exceptions import PortalSerializerException
from jumpcrypto.transactions.serializers.base import BaseSerializer
...
class Serializer(object):
    ...
    def __init__(self, transaction):
        if not transaction:
            raise PortalSerializerException("No transaction data provided")
    ...
    def _handle_transaction_type(self, bytes_data):
        ...
        module = import_module("jumpcrypto.transactions.serializers.{}".format(serializer_name))
