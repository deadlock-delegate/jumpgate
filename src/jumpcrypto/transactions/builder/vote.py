from jumpcrypto.constants import TRANSACTION_VOTE
from jumpcrypto.identity.address import address_from_passphrase
from jumpcrypto.transactions.builder.base import BaseTransactionBuilder
