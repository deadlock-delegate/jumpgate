...
from jumpcrypto.constants import (
    TRANSACTION_DELEGATE_REGISTRATION,
    TRANSACTION_MULTI_SIGNATURE_REGISTRATION,
    TRANSACTION_SECOND_SIGNATURE_REGISTRATION,
    TRANSACTION_VOTE,
)
from jumpcrypto.exceptions import PortalInvalidTransaction
from jumpcrypto.schnorr import schnorr
from jumpcrypto.transactions.deserializer import Deserializer
from jumpcrypto.transactions.serializer import Serializer
...
class Transaction(object):
    ...
    def deserialize(self, serialized):
        ...
        Returns:
            jumpcrypto.transactions.transaction.Transaction: Transaction
        """
