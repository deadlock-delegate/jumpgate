...
from portal_crypto.configuration.network import get_network
from portal_crypto.constants import TRANSACTION_TYPES
...
class Serializer(object):
    ...
    def _handle_transaction_type(self, bytes_data):
        ...
        module = import_module("portal_crypto.transactions.serializers.{}".format(serializer_name))
