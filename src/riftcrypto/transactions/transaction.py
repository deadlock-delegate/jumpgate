...
from riftcrypto.exceptions import PortalInvalidTransaction
from riftcrypto.schnorr import schnorr
from riftcrypto.transactions.deserializer import Deserializer
from riftcrypto.transactions.serializer import Serializer
...
class Transaction(object):
    ...
    def deserialize(self, serialized):
        ...
        Returns:
            riftcrypto.transactions.transaction.Transaction: Transaction
        """
