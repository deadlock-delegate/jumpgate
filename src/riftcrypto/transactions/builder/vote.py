from riftcrypto.constants import TRANSACTION_VOTE
from riftcrypto.identity.address import address_from_passphrase
from riftcrypto.transactions.builder.base import BaseTransactionBuilder
