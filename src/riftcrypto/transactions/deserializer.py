...
from riftcrypto.transactions.deserializers.base import BaseDeserializer
...
class Deserializer(object):
    ...
    def _handle_transaction_type(self, asset_offset, transaction):
        ...
        module = import_module("riftcrypto.transactions.deserializers.{}".format(deserializer_name))
