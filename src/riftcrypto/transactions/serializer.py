...
from riftcrypto.configuration.network import get_network
from riftcrypto.constants import TRANSACTION_TYPES
...
class Serializer(object):
    ...
    def _handle_transaction_type(self, bytes_data):
        ...
        module = import_module("riftcrypto.transactions.serializers.{}".format(serializer_name))
