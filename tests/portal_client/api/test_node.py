...
def test_status_calls_correct_url():
    responses.add(
        responses.GET, "http://127.0.0.1:4002/node/status", json={"success": True}, status=200
    )
...
def test_syncing_calls_correct_url():
    responses.add(
        responses.GET, "http://127.0.0.1:4002/node/syncing", json={"success": True}, status=200
    )
...
def test_fees_calls_correct_url():
    responses.add(
        responses.GET, "http://127.0.0.1:4002/node/fees", json={"success": True}, status=200
    )
