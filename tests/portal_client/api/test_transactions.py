...
def test_all_calls_correct_url_with_default_params():
    responses.add(
        responses.GET, "http://127.0.0.1:4002/transactions", json={"success": True}, status=200
    )
...
def test_create_calls_correct_url_with_data():
    responses.add(
        responses.POST, "http://127.0.0.1:4002/transactions", json={"success": True}, status=200
    )
