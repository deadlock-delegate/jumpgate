...
from portal_crypto.constants import TRANSACTION_DELEGATE_RESIGNATION, TRANSACTION_TYPE_GROUP
from portal_crypto.networks.devnet import ArkDevnet
from portal_crypto.transactions.builder.delegate_resignation import DelegateResignation
