...
def test_multi_payment_deserializer():
    ...
    assert (
        actual.signature
        == "672e89e66a9c5d7d95c21ccd07a89a111f02823146c06f14689d2cf1efd645fb648258fcf2280486d2cae19f391796d72145d2a8e6f261e887e34cd1998bdb65"
    )
    ...
    assert (
        actual.asset["payments"][0]["recipientId"] == "AHXtmB84sTZ9Zd35h9Y1vfFvPE2Xzqj8ri"
    )  # noqa
    assert actual.asset["payments"][1]["amount"] == 2  # noqa
    assert (
        actual.asset["payments"][1]["recipientId"] == "AZFEPTWnn2Sn8wDZgCRF8ohwKkrmk2AZi1"
    )  # noqa
